    ...
    public class Migrations : DataMigrationImpl
    {
        ...
        public int Create()
        {
            ...
            SchemaBuilder.ExecuteSql("CREATE PROCEDURE LETS_GetMemberTransactions @idMember int, @pageSize int, @pageNumber int AS BEGIN "
                + "SELECT * INTO #memberTransactions FROM "
                ...
                + "FROM LETS_TransactionPartRecord t JOIN Orchard_Framework_ContentItemVersionRecord v on v.ContentItemRecord_id = t.Id "
                + "WHERE BuyerMemberPartRecord_Id = @idMember AND v.Published = 1) AS memberTransactions "
                + "SELECT * INTO #sortedMemberTransactions FROM "
                ...
                + "FROM #memberTransactions mt) AS sortedMemberTransactions DROP TABLE #memberTransactions "
