...
namespace Contrib.ImageField.Drivers {
    ...
    public class ImageFieldDriver : ContentFieldDriver<Fields.ImageField> {
        ...
        public ImageFieldDriver(IOrchardServices services, IMediaLibraryService mediaService) {
        ...
        public ImageFieldDriver(IMediaLibraryService mediaService)
        {
            _mediaService = mediaService;
        }
                    ...
                    //if (_mediaService.FileAllowed(postedFile)) {
                        ...
                        if (target != null) {
                            using (var imageStream = new MemoryStream()) {
                                ...
                                uploadedFileName = _mediaService.UploadMediaFile(mediaFolder, uniqueFileName, imageStream.ToArray());
                            }
